...
def run_gr00t_sim_policy(
    ...
    # Allow disabling video on platforms where ffmpeg recording is fragile
    # (notably Windows). Pass --video-dir none|disable to skip recording.
    if video_dir in ("none", "disable"):
        video_dir = None
...
class RolloutConfig:
    ...
    Pass 'none' or 'disable' to skip video recording (useful on Windows)."""
