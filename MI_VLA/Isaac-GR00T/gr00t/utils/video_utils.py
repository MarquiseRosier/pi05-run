...
def get_frames_by_indices(
    ...
    # torchcodec expects int64/Long indices. On Windows, np.arange defaults to
    # int32, which raises: RuntimeError: expected scalar type Long but found Int.
...
def get_all_frames(
    ...
    """
    decoder = _build_decoder(video_path, decoder_kwargs)
    frames = decoder.get_frames_at(indices=np.arange(len(decoder), dtype=np.int64))
